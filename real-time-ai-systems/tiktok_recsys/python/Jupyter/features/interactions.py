...
def generate_interactions(num_interactions: int, users: List[Dict[str, str]], videos: List[Dict[str, str]]) -> List[
    ...
    for _ in range(num_interactions):
        ...
        user_registration_date = datetime.strptime(user['registration_date'], config.DATE_TIME_FORMAT)
        video_upload_date = datetime.strptime(video['upload_date'], config.DATE_TIME_FORMAT)
...
def generate_user_interactions_window_agg(num_interactions: int, users: List[Dict[str, str]],
                                          videos: List[Dict[str, str]]) -> List[Dict[str, Any]]:
    """
    Generate a list of dictionaries, each representing an interaction between a user and a video.
...
def generate_video_interactions_window_agg(num_interactions: int, users: List[Dict[str, str]],
                                           videos: List[Dict[str, str]]) -> List[Dict[str, Any]]:
    """
    Generate a list of dictionaries, each representing an interaction between a user and a video.
