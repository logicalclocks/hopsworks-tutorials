...
<span style="font-width:bold; font-size: 1.4rem;">
  This is an <b>advanced example</b> of the Hopsworks Feature Store usage; you are tasked with predicting the fare amount for a taxi ride in New York City given the pickup, dropoff locations and some other features.
